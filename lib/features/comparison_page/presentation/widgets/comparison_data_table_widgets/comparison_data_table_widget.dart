...
class ComparisonDataTableWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ComparisonDataTableWidget> createState() => _ComparisonDataTableWidgetState();
}

class _ComparisonDataTableWidgetState extends ConsumerState<ComparisonDataTableWidget> {
  @override
  Widget build(BuildContext context) {
    String firstProductDescription = ref.watch(comparisonFirstProductDescriptionStateProvider);
    String secondProductDescription = ref.watch(comparisonSecondProductDescriptionStateController);
