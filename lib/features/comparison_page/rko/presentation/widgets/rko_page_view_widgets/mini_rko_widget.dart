...
class MiniRkoWidget extends StatelessWidget {
  final VoidCallback onDelete;
  final ListRkoModel rko;
  ///виджет рко в сравнении , используется в [ComparisonRkoPage]
  const MiniRkoWidget({super.key, required this.onDelete,  required this.rko});
    ...
    return Container(
      decoration: BoxDecoration(
          color: Color(int.parse(
              '0xff${rko.bankDetails?.color}')), borderRadius: BorderRadius.circular(14)),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Image.network(
              '${Urls.api.files}/${rko.bankDetails?.logo}',
