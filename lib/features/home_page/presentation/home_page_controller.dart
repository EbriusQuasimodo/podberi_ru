...
final productTypeTitleFromHomeStateProvider = StateProvider.autoDispose<String>((ref) {
  return '';
});
///product type url which select on [SelectProductTypeWidget] used for instance in api
final productTypeUrlFromHomeStateProvider = StateProvider.autoDispose<String>((ref) {
  return '';
});