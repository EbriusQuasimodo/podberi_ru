...
class DebitCardInfoWidget extends StatelessWidget {
  ...
  const DebitCardInfoWidget({super.key, required this.productInfo, required this.basicApiPageSettingsModel});
