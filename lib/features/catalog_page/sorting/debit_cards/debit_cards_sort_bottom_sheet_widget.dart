...
class DebitCardsSortBottomSheetWidget extends ConsumerStatefulWidget {
  ...
  const DebitCardsSortBottomSheetWidget({
    super.key,
  ...
  @override
  ConsumerState<DebitCardsSortBottomSheetWidget> createState() =>
      _DebitCardsSortBottomSheetWidgetState();
}

class _DebitCardsSortBottomSheetWidgetState
    extends ConsumerState<DebitCardsSortBottomSheetWidget> {
