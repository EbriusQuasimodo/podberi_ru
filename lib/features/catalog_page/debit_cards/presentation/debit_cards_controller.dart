...
import 'package:podberi_ru/features/catalog_page/debit_cards/data/debit_cards_repository.dart';
...
class DebitCardsController extends AutoDisposeFamilyAsyncNotifier<
  ...
  FutureOr<DebitCardsModel> build(BasicApiPageSettingsModel arg) async {
    ...
    final debitCardsRepo = ref.watch(debitCardsRepositoryProvider);
